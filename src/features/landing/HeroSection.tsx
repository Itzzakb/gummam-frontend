...
export const HeroSection: React.FC = () => {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 font-poppins bg-[#FAFAFA] pb-10">
          ...
          <div className="mt-8 relative w-full lg:w-[130%] xl:w-[140%] z-20 font-poppins">
            ...
            <div className="bg-white rounded-b-2xl rounded-tr-none sm:rounded-tr-2xl shadow-[0_15px_40px_rgba(0,0,0,0.08)] p-4 sm:p-5 flex flex-col lg:flex-row items-stretch lg:items-center gap-4 w-full lg:w-max">
              ...
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 w-full lg:w-auto">
                {/* Mic Icon */}
                <button className="w-[52px] h-[52px] rounded-full bg-gray-100/80 flex items-center justify-center hover:bg-gray-200 transition-colors shrink-0">
                ...
                <button 
                  ...
                  className="flex-1 sm:flex-initial bg-[#E67817] hover:bg-[#D5680E] text-white px-7 py-4 rounded-full font-medium text-[14px] transition-colors flex items-center justify-center gap-2 shrink-0 shadow-lg shadow-orange-500/20"
                >
                ...
                {/* AI Search */}
                <div className="flex-1 sm:flex-initial rounded-full p-[2px] bg-gradient-to-r from-[#4885FF] to-[#F68035] shrink-0 shadow-lg shadow-blue-900/20">
                  <button className="bg-[#035096] hover:bg-[#024078] text-white px-7 py-4 rounded-full font-medium text-[14px] transition-colors flex items-center justify-center gap-2 w-full h-full">
      ...
      <div className="fixed bottom-4 sm:bottom-8 right-0 sm:right-8 z-50 scale-75 sm:scale-100 origin-bottom-right">
